...
# Dumping structure for table ragna4fun.crosswords_comment
CREATE TABLE IF NOT EXISTS `crosswords_comment` (
...
# Dumping structure for table ragna4fun.crosswords_server
CREATE TABLE IF NOT EXISTS `crosswords_server` (
