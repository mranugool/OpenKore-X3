...
# Dumping structure for table ragna4fun.scattergories_comment
CREATE TABLE IF NOT EXISTS `scattergories_comment` (
...
# Dumping structure for table ragna4fun.scattergories_server
CREATE TABLE IF NOT EXISTS `scattergories_server` (
