...
CEXTERN void Safer_Init_Module(void);
CEXTERN void Safer_Expand_Userkey(safer_block_t userkey_1,
									safer_block_t userkey_2,
									unsigned int nof_rounds,
									int strengthened,
									safer_key_t key);
CEXTERN void Safer_Encrypt_Block (safer_block_t block_in, safer_key_t key,
									safer_block_t block_out);
CEXTERN void Safer_Decrypt_Block (safer_block_t block_in, safer_key_t key,
									safer_block_t block_out);
